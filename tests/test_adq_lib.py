...
def xtest_notebook_build():
    subprocess.check_call([
        "jupyter", "nbconvert",
        "--to", "notebook",
        "--output", "generated.ipynb",
        "adqs.ipynb"])
...
def test_unit_dose():
    subject = {
        ...
        'ingredient_count': 1.0,
        'squ': 'unit',
        'bnf_name': 'Imigran_Nsl Spy 10mg/0.1ml Ud',
        'adq_value': 0.02,
        'adq_denominator': 'g',
        'dose_multiplier': 1.0,
        'quantity_denominator': 'unit'
...
def test_unit_dose_with_percent():
    subject = {
        ...
        'ingredient_count': 1.0,
        'squ': 'unit',
        'bnf_name': 'Pirinase_Hayfever Nsl Spy 0.05% (60D)',
        'adq_value': 0.002,
        'adq_denominator': 'g',
        'dose_multiplier': 60.0,
        'quantity_denominator': 'unit',
        'adq_per_quantity': 1.5
    }
    # XXX not worked out what this *should* be yet
    assert _apply_adq(subject) == 0.5
...
def test_another_dose():
    subject = {
        ...
        'ingredient_count': 1.0,
        'squ': 'unit',
        'bnf_name': 'Nasofan_Allergy Aq Nsl Spy 50mcg (60 D)',
        'adq_value': 0.002,
        'adq_denominator': 'g',
        'dose_multiplier': 60.0,
        'quantity_denominator': 'unit',
